...
VALUES
('Skirt', 'Quality and comfortable', 'skirt.jpg', 1),
('notebook', 'RAM 56GB SSD', 'notebooks.jpg', 2),
...
VALUES 
(145.99, '2022-12-01', 'Summer collection', 1),
(998.99, '2022-06-01', 'Launch price', 2),
(499.99, '2022-08-01', 'Limited offer', 3),
(709.99, '2022-09-01', 'Fall collection', 4);
...
VALUES 
('Q1001', '2022-01-01', 'First shipment from Apple Inc.', 1, 1),
('Q1002', '2022-02-01', 'Monthly shipment from Best Buy', 2, 2),
('Q1003', '2022-03-01', 'Weekly shipment from Samsung', 3, 3),
('Q1004', '2022-04-01', 'Monthly shipment from Costco', 4, 4);

INSERT INTO oplataPostavki (dataOp, summa, comments, id_postavki)
VALUES 
('2022-01-05', 1000, 'Payment for shipment Q1001', 1),
('2022-02-01', 2000, 'Payment for shipment Q1002', 2),
('2022-03-10', 1500, 'Payment for shipment Q1003', 3),
('2022-04-15', 2500, 'Payment for shipment Q1004', 4);
...
VALUES 
('Anna', 'A', 'Doe', '1234565466', '1password', 'annadoe', 'Apple', 10, 1, 1),
('Doe', 'B', 'John', '125654542781', '2password', 'doejohn', 'Microsoft', 20, 2, 2),
('Aku', 'C', 'Smith', '1223344556', '3password', 'akujim', 'Google', 30, 3, 3);
...
VALUES ('Manager'), ('Tester'), ('Sales representative'), ('Accountant'), ('Secretary');

INSERT INTO sotrudnik (fam, imya, otch, id_doljnist)
VALUES 
('Akylbek kyzy', 'Gulzina', '--', 1),
('Satybaldieva', 'Aida', 'Akylbekovna', 3),
('Ermatova', 'Aiperi', 'Asanbekova', 4);
...
VALUES ('2023-02-11', '0001', 'Good 1', 1, 1, 1, 1, 1),
       ('2023-02-12', '0002', 'Succesfully 2', 2, 2, 2, 2, 2),
       ('2023-02-13', '0003', 'Exectly 3', 3, 3, 3, 3, 3);
